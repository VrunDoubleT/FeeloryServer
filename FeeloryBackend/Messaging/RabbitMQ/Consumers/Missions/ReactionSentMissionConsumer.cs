...
public class ReactionSentMissionConsumer : RabbitMqConsumerBase<PostReactionAddedMessage>
{
    public ReactionSentMissionConsumer(
    ...
    protected override string QueueName => MissionQueues.ReactionSent;
        ...
        PostReactionAddedMessage message)
    {
        ...
        await missionService.ProcessReactionSentAsync(
            message.ReactorId,
            message.PostId);
    }
}